    ...
    <div className="min-h-screen bg-[#faf8f5] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-[#1a4037] mb-2">Welcome Back</h2>
          <p className="text-[#5a5a5a]">Sign in to your TradiFeast account</p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-sm text-[#1a4037] hover:text-[#0f2b21] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-[#5a5a5a]">Or continue with</span>
              </div>
            </div>
          </div>
